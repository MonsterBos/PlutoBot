...
""" Birkaç küçük komutu içeren MoonBot modülü. """
...
import io
import sys
from MoonBot import BOTLOG, BOTLOG_CHATID, ASISTAN, MYID, CMD_HELP, bot, WHITELIST
...
async def raw(event):
    ...
    with io.BytesIO(str.encode(the_real_message)) as out_file:
        ...
        await event.edit(
            "`Çözülmüş mesaj için MoonBot loglarını kontrol et!`")
