...
""" Userid, chatid ve log komutlarını içeren MoonBot modülü """

from asyncio import sleep
from MoonBot import CMD_HELP, BOTLOG, BOTLOG_CHATID, bot, BLACKLIST_CHAT
from MoonBot.events import register
from MoonBot.modules.admin import get_user_from_event
...
async def unmute_chat(unm_e):
    ...
    try:
        from MoonBot.modules.sql_helper.keep_read_sql import unkread
...
async def mute_chat(mute_e):
    ...
    try:
        from MoonBot.modules.sql_helper.keep_read_sql import kread
    except AttributeError:
...
async def keep_read(message):
    """ Mute mantığı. """
    try:
        from MoonBot.modules.sql_helper.keep_read_sql import is_kread
    except AttributeError:
        return
    kread = is_kread()
    if kread:
