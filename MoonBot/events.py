...
# OwenMoonBot - ErdewBey - Ber4tbey

""" Olayları yönetmek için MoonBot modülü.
 MoonBot'un ana bileşenlerinden biri. """
import re
...
import base64
from MoonBot import bot, BOTLOG_CHATID, LOGSPAMMER, PATTERNS, OWEN_VERSION, ForceVer
          ...
          #  pass
            ...
            try:
                ...
                if not disable_errors:
                    ...
                    if LOGSPAMMER:
                        try:
                            await check.edit("`❕ Üzgünüm, MoonBot bir hatayla karşılaştı.\n ℹ️ Hata günlükleri MoonBot günlük grubunda saklanır.`")
                        except:
                            pass
